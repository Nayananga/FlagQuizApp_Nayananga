...
public class QuizViewModel extends ViewModel {
    ...
    void resetTotalGuesses() {
        this.totalGuesses = 0;
    }

    HashMap<String, String> getFileNameList() {
        return fileNameList;
    }

    void setFileNameList(AssetManager assets) {
        Object obj;
    ...
    PopupWindow setPopUpWindowCorrect(View view, Context mContext) {
    ...
    PopupWindow setPopUpWindowWrong(View view, Context mContext) {
        mContext.getApplicationContext();
        LayoutInflater inflater = (LayoutInflater)mContext.getSystemService(LAYOUT_INFLATER_SERVICE);
    ...
    List<String> getCorrectAnswerList() {
        return correctAnswerList;
    }

    void setCorrectAnswerList(String correctAnswer) {
        this.correctAnswerList.add(correctAnswer);
    }

    void clearCorrectAnswersList(){
        this.correctAnswerList.clear();
    }

    String getNextCountryFlagRemove() {
